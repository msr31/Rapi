<template>
  <v-app>
    ...
    <v-footer
      ...
      class="fondo-blanco hidden-print-only"
      :fixed="fixed"
      app
    >
      <span>
        <strong>Sublime POS 3 - Punto de venta gratuito</strong> programado con
        <v-icon color="red">favorite</v-icon> por
        <a href="https://parzibyte.me/" target="_blank">Parzibyte</a>.
      </span>
    </v-footer>
  </v-app>
</template>
