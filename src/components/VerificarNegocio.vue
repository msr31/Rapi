<template>
  <v-layout row wrap>
    ...
    <v-flex v-show="procesoTerminado" xs12 class="text-xs-center">
      ...
      <p class="subheading">Hemos creado una aplicaci&oacute;n de punto de venta totalmente gratuita, lo que nos motiva
        es
        que m&aacute;s
        usuarios se integren a la plataforma.
        <br>
        <strong>Por favor, comparte</strong></p>
      <a class="link-img"
         :href="enlaces.facebook"
         target="_blank">
        <img title="Compartir en Facebook" class="rounded-circle img-thumbnail"
      ...
      <a class="link-img"
         :href="enlaces.twitter"
         target="_blank">
        <img title="Compartir en Twitter" class="rounded-circle img-thumbnail"
      ...
      <a class="link-img"
         :href="enlaces.telegram"
         target="_blank">
        <img title="Compartir en Telegram" class="rounded-circle img-thumbnail"
      ...
      <a class="link-img" :href="enlaces.whatsapp" target="_blank">
        <img title="Compartir en WhatsApp" class="rounded-circle img-thumbnail"
...
<script>
  ...
  export default {
    ...
    data: () => ({
      enlaces: {
        facebook: `https://www.facebook.com/sharer.php?u=${EnlaceCompartir}&t=${MensajeCompartir}`,
        twitter: `https://www.twitter.com/intent/tweet?hashtags=PuntoDeVenta,POS,App,SublimePOS&text=${MensajeCompartir}&url=${EnlaceCompartir}`,
        whatsapp: `https://api.whatsapp.com/send?text=${MensajeCompartir}${encodeURIComponent(": ")}${EnlaceCompartir}`,
        telegram: `https://telegram.me/share/url?url=${EnlaceCompartir}&text=${MensajeCompartir}`,
      },
      idIntervalo: null,
      valor: 0,
